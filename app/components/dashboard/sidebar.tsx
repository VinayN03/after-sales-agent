...
export function Sidebar({
  ...
  return (
    <nav className={`flex-shrink-0 flex flex-col items-center bg-white border-r border-slate-100 py-3 transition-[width] duration-200 ease-out ${collapsed ? "w-[52px]" : "w-[74px]"}`}>
