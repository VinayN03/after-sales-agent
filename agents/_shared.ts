...
export type OrderStatus = "pending" | "shipped" | "delivered" | "refund_requested" | "refund_approved" | "refund_rejected" | "refund_completed" | "exchange_requested" | "exchange_shipped";
